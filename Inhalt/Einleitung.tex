...
Die \ac{CBP-AD} ist eine Desktopanwendung mit der jeweilige benötigte Dokumente, Anlagen und Schreiben für Betriebsprüfungen erzeugt werden können. Sie ist in \ac{VB}.NET mit einer Windows-Forms-Oberfläche implementiert. Die entsprechenden Daten zum Einbinden in die Dokumente werden über die Desktopanwendung \ac{CBP-NB}, durch die Berechnungen zu den Sozialabgaben von Betrieben berechnet werden können, angefordert.
